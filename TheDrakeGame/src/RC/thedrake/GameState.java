...
public class GameState implements JSONSerializable {
	...
	public Tile tileAt(BoardPos pos) {
		Optional<TroopTile> optTroop = blueArmy.boardTroops().at(pos);
		if (optTroop.isPresent()) {
			return optTroop.get();
		}

		optTroop = orangeArmy.boardTroops().at(pos);
		if (optTroop.isPresent()) {
			return optTroop.get();
		}
	...
	public boolean canPlaceFromStack(TilePos target) {
		...
		for (BoardPos pos : onTurn.boardTroops().troopPositions()) {
