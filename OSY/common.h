...
//=================================================================================================
class CPriceList {//list produktu + materialId
public:
...
//=================================================================================================
class COrder {//objednavka
public:
    COrder(unsigned w, unsigned h, double weldingStrength)
            : m_W(w), m_H(h), m_WeldingStrength(weldingStrength), m_Cost(0) {
    }
...
//=================================================================================================
class COrderList {//seznam objednavek
public:
...
//=================================================================================================
class CProducer : public std::enable_shared_from_this<CProducer> {//dodavatel
public:
...
//=================================================================================================
class CCustomer : public std::enable_shared_from_this<CCustomer> {//zakaznik
public:
